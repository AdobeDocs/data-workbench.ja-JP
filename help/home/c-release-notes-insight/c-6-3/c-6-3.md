...
* **[!UICONTROL ファインダー]**&#x200B;パネルから指標列の外にある指標の凡例に指標をドラッグすると、ワークスペースから凡例が削除される問題を修正しました。
* **[!UICONTROL 印刷ワークスペース]**&#x200B;で&#x200B;**[!UICONTROL サイドバー]**&#x200B;と&#x200B;**[!UICONTROL 両方]**&#x200B;のオプションを使用すると、印刷されたページに著作権情報が含まれない問題を修正しました。
