...
1. トランスミッターが Sensor プログラム・ファイルをインストールしたディレクトリにディスク・キュー (Diskq2000.log) を作成し、txlogd.conf ファイルの QueueSize パラメーターで指定したサイズであることを確認します。
